...
The current research package is **PAIA-SEMANTIC-LAB-v0.3-REMEDIATION**. It is frozen and `REM-00` is READY but not authorized. Its canonical state is `status/SEMANTIC_REMEDIATION_STATUS.yaml`.
